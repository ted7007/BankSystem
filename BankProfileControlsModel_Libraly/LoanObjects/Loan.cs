...
namespace BankProfileControlsModel_Libraly.LoanObjects
{
    public class Loan:INotifyPropertyChanged,IProfileControl
    {
        ...
        public Loan(Action<NotifyEventArgs> notifyRelease, decimal startLoanAmount, int loanRate, DateTime startPeriod, int profileId)
        {
